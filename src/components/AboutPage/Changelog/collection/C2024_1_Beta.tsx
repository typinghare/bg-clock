...
export class C2024_1_Beta extends Changelog {
    public constructor() {
        ...
        this.added(<span>Countdown audios to remind players.</span>)
        this.added(<span>Users can check the descriptions of time controls by clicking a question mark icon.</span>)
